  ...
  return (
    <div className={classes.root}>
      <Accordion className={classes.accordion}>
        ...
        <SidebarDetail item={item} projectIndex={projectIndex} setShowUml={(value)=>setShowUml(value)}/>
        <AccordionActions>
          <Menu item={item} projectIndex={projectIndex} setOpen={setOpen} setShowUml={(value)=>setShowUml(value)} />
        </AccordionActions>
      </Accordion>
      {open ? (
        <Modal
